...
public class ClassFileManager extends ForwardingJavaFileManager {
     ...
     * stored in the testCompiler.JavaClassObject, and returns the Class for it
     */
    @Override
    ...
    /**
     * Gives the compiler an instance of the testCompiler.JavaClassObject so that the compiler can write the byte
     * code into it.
     */
    @Override
